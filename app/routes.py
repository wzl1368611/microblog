...
from app.forms import LoginForm,RegistrationForm,EditorProfileForm,PostForm,ResetPasswordRequestForm
...
def index():
    ...
    user = {'username': 'wangzhilong'}
    # return 'Hello world!'
    # return '''
    # <html>
    #     <head>
    #         <title>Home Page - wanghzilong</title>
    #     </head>
    #     <body>
